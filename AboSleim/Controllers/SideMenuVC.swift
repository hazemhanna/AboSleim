...
class SideMenuVC: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
       ...
       // if token != "" {
                self.sideMenuArr = [
                    SideMenuModel(name: "Home".localized,id: "home", selected: false,sideImage: #imageLiteral(resourceName: "ic_assignment_ind_24px")),
                    ...
                    SideMenuModel(name: "Cart".localized, id: "Cart", selected: false,sideImage: #imageLiteral(resourceName: "loupe")),
                    ...
                    SideMenuModel(name: "MyReservations".localized, id: "Reservations", selected: false, sideImage: #imageLiteral(resourceName: "reservation2")),
                    ...
                    SideMenuModel(name: "FoodCart".localized, id: "FoodCart", selected: false,sideImage: #imageLiteral(resourceName: "minus-1")),
